...
console.log("First & Last names of all Inventors");
...
console.log(`Total years all Inventors lived:`, sum);
...
const data = ["car", "car", "truck", "truck", "bike", "walk", "car", "van", "bike", "walk", "car", "van", "car", "truck", "douche"];
